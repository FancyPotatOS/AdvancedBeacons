...
data modify block ~ ~ ~ Items[{Slot:10b}].components."minecraft:custom_data".beacon.state set value "disabled"
data modify block ~ ~ ~ Items[{Slot:10b}].components."minecraft:custom_data".beacon.effect set value "disabled"
data modify block ~ ~ ~ Items[{Slot:10b}].components."minecraft:custom_model_data".strings[0] set value "disabled"
